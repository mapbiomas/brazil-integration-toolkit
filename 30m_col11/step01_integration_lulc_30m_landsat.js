...
var outputAsset = 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/INTEGRATION/classification';
var outputVersion = '0-4';
var collection_id = 11

var exportToAsset = true;

var description = [
    "### Description",
    "Collection 11 asset update",
    "- **Enhancements**: .",
    ...
    "|:------------------|--------:|:----------|:------------------|",
    "| Amazônia          | 6       | 22-06     | Bruno             |",
    "| Caatinga          | 5       | 08-06     | Soltan            |",
    "| Cerrado           | 6       | 13-06     | Bárbara           |",
    "| Mata Atlântica    | 78      | 22-06     | Natalia           |",
    "| Pampa             | 8       | 22-06     | Velez             |",
    "| Pantanal          | 39      | 22-06     | Mariana           |",
    "| Mineração         | 10      | 24-06     | Cortinhas         |",
    "| Aquicultura       | 6       | 06-06     | M. Luize          |",
    "| Zona Costeira     | 8       | 22-06     | Julia             |",
    "| Agricultura       | 8       | 22-06     | Kenia             |",
    "| Floresta Plantada | 8       | 22-06     | Kenia             |",
    "| Pastagem          | 3       | 22-06     | Vinicius          |",
    "| Urbano            | 7       | 18-06     | Julio             |",
    "| Fotovoltaico      | 2       | 13-06     | Soltan            |",
    "| Eólicas           | 3       | 18-06     | Soltan            |",
    "| Agua              | v4      | 15-06     | Mariana           |",
];
...
var App = {
    ...
    options: {
        ...
        assets: [
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/classification-amz-ft',
                'territory': 'AMAZONIA','type': 'classification_singleband_collection',
                'version': '6','theme': 'AMAZONIA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/classification-caa',
                'territory': 'CAATINGA','type': 'classification_singleband_collection',
                'version': '5','theme': 'CAATINGA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/classification-cer-ft',
                'territory': 'CERRADO','type': 'classification_singleband_collection',
                'version': '6','theme': 'CERRADO'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/classification-mat-ft',
                'territory': 'MATAATLANTICA','type': 'classification_multiband_collection',
                'version': '78','theme': 'MATAATLANTICA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/classification-pam-ft',
                'territory': 'PAMPA','type': 'classification_singleband_collection',
                'version': '8','theme': 'PAMPA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/classification-pan-ft',
                'territory': 'PANTANAL','type': 'classification_multiband_collection',
                'version': '39','theme': 'PANTANAL'
            },
            // transversal data
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/MINING/classification-ft',
                'territory': 'BRAZIL','type': 'classification_singleband_collection',
                'version': '10','theme': 'MINERACAO'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/AQUACULTURE/classification',
                'territory': 'BRAZIL','type': 'classification_singleband_collection',
                'version': '6','theme': 'AQUICULTURA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/COASTAL-ZONE/classification',
                'territory': 'BRAZIL','type': 'classification_singleband_collection',
                'version': '8','theme': 'ZONACOSTEIRA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/AGRICULTURE/classification',
                'territory': 'BRAZIL','type': 'classification_singleband_collection',
                'version': '8','theme': 'AGRICULTURA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/AGRICULTURE/classification',
                'territory': 'BRAZIL','type': 'classification_singleband_collection',
                'version': '8','theme': 'FLORESTAPLANTADA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/PASTURE/classification',
                'territory': 'BRAZIL','type': 'classification_singleband_collection',
                'version': '3','theme': 'PASTAGEM'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/URBAN/classification',
                'territory': 'BRAZIL','type': 'classification_multiband_collection',
                'version': 7,'theme': 'INFRAURBANA'
            },
            {
                'asset_id': 'projects/mapbiomas-public/assets/brazil/water/collection5/mapbiomas_brazil_collection5_water_annual_v4',
                'territory': 'BRAZIL','type': 'classification_multiband_image',
                'version': 'v4','theme': 'AGUA'
            },
            // {
            //     'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-10/REEFS/classification',
            //     'territory': 'BRAZIL','type': 'classification_singleband_collection',
            //     'version': '1','theme': 'CORAIS'
            // },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/RENEWABLE-ENERGY/solar-panels',
                'territory': 'BRAZIL','type': 'classification_singleband_collection',
                'version': 2.0,'theme': 'FOTOVOLTAICO'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/RENEWABLE-ENERGY/wind-energy',
                'territory': 'BRAZIL','type': 'classification_singleband_collection',
                'version': '3','theme': 'EOLICA'
            },
            // collections
            // {
            ...
            // },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-10/INTEGRATION/classification',
                'territory': 'BRAZIL',
            ...
            // other
            {
                'asset_id': 'projects/mapbiomas-workspace/AUXILIAR/biome_2025_buf5k_30m',
                'territory': 'BRAZIL',
            ...
            {
                'asset_id': 'projects/mapbiomas-workspace/AUXILIAR/bioma25_uf24_30m',
                'territory': 'BRAZIL',
                'type': 'classification_singleband_image',
                'version': null,
                'theme': 'STATES'
        ...
        var prevalenceList = [
                    ...
                    'rule': [
                        {
                            ...
                            'class_input': [335,435,151,351,651], // 231,331,431=MG, 335,435=SP, 151,351,651=MT
            ...
            },
            {
                ...
                'exception': {
                    ...
                    'rule': [
                        {
                            'class_input': [3, 4, 7, 11, 12, 29, 33], 
                            'source': App.options.classification.select(['classification', App.options.year].join('_'))
                        }
                    ],
                    'class_output': [3, 4, 7, 11, 12, 29, 33] 
                }
            },
            {
                'prevalence_id': 15,
            ...
            },
            {
                ...
                'exception': {
                    ...
                    'class_output': [3, 4, 7, 11, 12, 29, 33] // expected to be a list
                }
            },
            {
            ...
            },
            {
                ...
                'exception': {
                    'rule': [
                        {
                            'class_input': [1], //todo: checar tb com o GT agua
                            'source': App.options.classification.select(['classification', App.options.year].join('_'))
                        }
                    ],
                    'class_output': 33
            ...
            },
            {
                ...
                'exception': {
                    'rule': [
                        {
                            'class_input': [1], //todo: checar com o GT agua
                            'source': App.options.classification.select(['classification', App.options.year].join('_'))
                        }
                    ],
                    'class_output': 33
            ...
            {
                'prevalence_id': 45, // CERRADO EXCEPTION
                'label': 'Formação Savânica',
                'rule': {
                    'class_input': 4,
                    'class_output': 4,
            ...
            {
                'prevalence_id': 63, // especifica para a exceção em ucs no cerrado
    ...
    loadLayers: function () {
        App.options.layers = [
            ...
            // },
            {
                'name': 'Collection 10.0 (version ' + App.getAssetData('COLLECTION100')[0].version + ')',
...
var gridNames = [
    ...
    "SD-23", "SD-24", "SE-20", "SE-22", "SE-23", "SE-24", 
...
if (exportToAsset) {
  ...
  var OceanFiximg = OceanFix.reduceToImage({properties: ['class'],reducer: ee.Reducer.first()});
  integrated = integrated.blend(OceanFiximg)
    gridNames.forEach(
        function (gridName) {
