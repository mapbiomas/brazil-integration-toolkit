...
var geometry = /* color: #d63000 */ee.Geometry.Point([-52.13592894546439, -31.468046285800916]);
 ...
 */
var outputAsset = 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/INTEGRATION/classification';
var outputVersion = '0-04';
var colName = 'col4-10m-'
// '0-1' - exportado em janeiro de 2026
// '0-2' - exportado em fevereiro de 2026 - faltando apeans ajuste na Amazônia
// '0-3' - exportado em março de 2026
// '0-4' - exportado em março de 2026 - ajustada mineraçao para v11
// '0-5' - exportado em 18 março de 2026 - ajustada Amazônia v4 com 10m
// '0-6' - ajustes nas regras de integração e novo filtro espacial (com erro na logica da água)
// '0-7' - filtro espacial corrigido
// '0-8' - versão 5 da Amazônia
// '0-9' - versão 6 Amazönia e 13 mineração... sem filtro espacial
// '0-10' - versão 14 mineração e 4 da silvicultura - nova regra de integração com silvicultura não entrando sobre água

var nativeScale = 10; 

var sentinel = ee.ImageCollection('projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/INTEGRATION/classification')
print('integration vesion',sentinel.aggregate_histogram('version'))


var description = '# Sentinel-2 Collection 4.0 \n' +
    "### Output Version:" + outputVersion + " \n" +
    "| Layer             | Version | Uptade date           | User              |\n" +
    "|:------------------|--------:|:----------------------|:------------------|\n" +
    "| Amazônia          | 1       | 03/07/2026            |                   |\n" +
    "| Caatinga          | 7       | 02/07/2026            |                   |\n" +
    "| Cerrado           | 2       | 01/07/2026            |                   |\n" +
    "| Mata Atlântica    | 16      | 01/07/2026            |                   |\n" +
    "| Pampa             | 1       | 02/07/2026            |                   |\n" +
    "| Pantanal          | 7       | 02/07/2026            |                   |\n" +
    "| Mineração         | 1       | 01/07/2026            |                   |\n" +
    "| Aquicultura       | 4       | 01/07/2026            |                   |\n" +
    "| Zona Costeira     | 1       | 01/07/2026            |                   |\n" +
    "| Agricultura       | 2       | 09/07/2026            |                   |\n" +
    "| Floresta Plantada | 2       | 09/07/2026            |                   |\n" +
    "| Pastagem          | 1       | 01/07/2026            |                   |\n" +
    "| Urbano            | 2       | 01/07/2026            |                   |\n" +
    "| Fotovoltaica      | 2       | 01/07/2026            |                   |\n" +
    "| Eólica            | 2       | 01/07/2026            |                   |\n";
...
var App = {
    ...
    options: {
        ...
        assets: [
            // biomes data
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/GENERAL/classification-amz-ft',
                'territory': 'AMAZONIA', 'type': 'classification_singleband_collection',
                'version': '1', 'theme': 'AMAZONIA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/GENERAL/classification-caa-ft',
                'territory': 'CAATINGA', 'type': 'classification_singleband_collection',
                'version': '7', 'theme': 'CAATINGA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/GENERAL/classification-cer-ft',
                'territory': 'CERRADO', 'type': 'classification_singleband_collection',
                'version': '2', 'theme': 'CERRADO'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/GENERAL/classification-mat-ft',
                'territory': 'MATAATLANTICA', 'type': 'classification_multiband_collection',
                'version': '16', 'theme': 'MATAATLANTICA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/GENERAL/classification-pam-ft',
                'territory': 'PAMPA', 'type': 'classification_singleband_collection',
                'version': '1', 'theme': 'PAMPA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/GENERAL/classification-pan-ft',
                'territory': 'PANTANAL', 'type': 'classification_multiband_collection',
                'version': '7', 'theme': 'PANTANAL'
            },
            // transversal data
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/MINING/classification-ft',
                'territory': 'BRAZIL', 'type': 'classification_singleband_collection',
                'version': '1', 'theme': 'MINERACAO'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/AQUACULTURE/classification',
                'territory': 'BRAZIL', 'type': 'classification_singleband_collection',
                'version': '4', 'theme': 'AQUICULTURA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/COASTAL-ZONE/classification',
                'territory': 'BRAZIL', 'type': 'classification_singleband_collection',
                'version': '1', 'theme': 'ZONACOSTEIRA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/AGRICULTURE/classification-ft',
                'territory': 'BRAZIL', 'type': 'classification_singleband_collection',
                'version': '2', 'theme': 'AGRICULTURA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/AGRICULTURE/classification-ft',
                'territory': 'BRAZIL', 'type': 'classification_singleband_collection',
                'version': '2', 'theme': 'FLORESTAPLANTADA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/PASTURE/classification',
                'territory': 'BRAZIL', 'type': 'classification_singleband_collection',
                'version': '1',  'theme': 'PECUARIA'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/URBAN/classification',
                'territory': 'BRAZIL', 'type': 'classification_singleband_collection',
                'version': 2,  'theme': 'INFRAURBANA'
            },
                        {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/RENEWABLE-ENERGY/solar-panels',
                'territory': 'BRAZIL', 'type': 'classification_singleband_collection',
                'version': 2, 'theme': 'PHOTOVOLTAIC'
            },
            {
                'asset_id': 'projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/RENEWABLE-ENERGY/wind-energy',
                'territory': 'BRAZIL','type': 'classification_singleband_collection',
                'version': '2','theme': 'EOLICA'
            },
            // mosaic data
            {
            ...
            {
                'asset_id': 'projects/mapbiomas-workspace/COLECAO9-S2/integracao',
                'territory': 'BRAZIL',
        ...
        'legend': { //TODO: revisar a legenda para a coleção 8.0
            'params': {
                ...
                "layers": [
                    ...
                    [palette[5], 5, 'Mangue'],
                    [palette[6], 6, 'Floresta Alagada'],
                    [palette[7], 7, 'Savana Alagada'],
        ...
        var prevalenceList = [
            ...
            },
            {
                ...
                'rule': {
                    ...
                    'class_output': 91,
                    // 'source': ee.Image(0),
                    'source': App.getAssetData('EOLICA')[0].image.select(['classification', App.options.year].join('_')),
                    'source_mask': null
                },
                'exception': null
            },
            ...
            {
                'prevalence_id': 28, // CERRADO EXCEPTION
                'label': 'Formação Savânica',
                'rule': {
                    'class_input': 4,
                    'class_output': 4,
            ...
            {
                'prevalence_id': 37, // CERRADO EXCEPTION
                'label': 'Formação Campestre',
                'rule': {
                    'class_input': 12,
                    'class_output': 12,
            ...
            {
                'prevalence_id': 45, // especifica para a exceção em ucs no cerrado
...
var Chart = {
    ...
    legend: {
        ...
        6: { 'color': palette[6], 'name': 'Floresta Alagavel' },
        7: { 'color': palette[7], 'name': 'Savana Alagada' },
 ...
 */
var modeSpatialFilter = function (image) {
  ...
  // Filtro de Exceção (Ex: Classes 33 e 75): fragmentos muito pequenos (< 15 px)
  // Aqui corrigi o remap para garantir que estamos mascarando as classes alvo
//  var mode_exc = mode_img.remap([33,75],[33,75]).mask(connect_1.lte(min_mapped_pixels_excessions));
  
  // 4. Composição final (Blending)
  // A ordem importa: o último blend fica no topo. 
  // Começamos com a moda geral e sobrepomos as regras específicas, 
  // e por fim, aplicamos tudo sobre a imagem original.
  var filtered = image
    .blend(mode_all) // Aplica a moda onde houver fragmentos pequenos gerais
    .blend(mode_21)  // Sobrepõe o tratamento para a classe 21
//    .blend(mode_exc); // Sobrepõe o tratamento de exceção (mais restrito)
...
var integratedList = ee.List(
    years.map(
        function (year) {
            ...
            // integrated = modeSpatialFilter(integrated);
    ...
    gridNames.forEach(
        function (gridName) {
            ...
            Export.image.toAsset({
                ...
                'description': colName + gridName + '-' + outputVersion,
