...
var description = 'Filter to remove 25 on beach'
// Set metadata

var inputVersion = '0-04-08-tra-1'
var outputVersion = '0-04-09-c25-1'

// Set input classification
var classification = ee.ImageCollection('projects/mapbiomas-brazil/assets/LAND-COVER-10M/COLLECTION-4/INTEGRATION/classification-ft')
...
function filterYear(year) {
  ...
  var band = classification.select(bandName);
...
var beforeBand = classification.select(BAND_PREFIX + VIS_YEAR);
